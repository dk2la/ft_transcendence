class GuildWar < ApplicationRecord
    ...
    def self.reacted?(id1, id2)
        case1 = !GuildWar.where(sender_guild_id: id1, recipient_guild_id: id2, status: "confirmed").empty?
        case2 = !GuildWar.where(sender_guild_id: id2, recipient_guild_id: id1, status: "confirmed").empty?
        case1 || case2
    end
